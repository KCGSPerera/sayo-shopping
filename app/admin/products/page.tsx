...
export default function Products() {
    ...
    const handleOpenModal = async (product: any = null) => {
        if (product) {
            ...
            setFormData({ name: "", price: "", category_id: "", color: "", description: "", is_active: true });
            setExistingImages([]);
        }
        setNewImageFiles([]);
        setIsModalOpen(true);
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '800px' }}>
                    ...
                    <tbody>
                        {loading ? (
                            ...
                            <tr><td colSpan={5} style={{ padding: '2rem', textAlign: 'center', color: '#666' }}>No products found</td></tr>
                        ) : (
                            products.map(product => (
                                <tr key={product.id} style={{ borderBottom: '1px solid var(--accent-grey)' }}>
                                    ...
                                    <td style={{ padding: '1rem', textAlign: 'right' }}>
                                        <button onClick={() => handleOpenModal(product)} style={{ color: '#4b5563', marginRight: '1rem' }} aria-label="Edit">
                                            <Edit size={18} />
                                        </button>
